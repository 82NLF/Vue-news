<template>
  <div tag="li" class="foot-btn" >
    <ul>
      <router-link tag="li" class="home" to="/home"><a href="javascript:;"></a></router-link>
      <router-link tag="li" class="write" to="/buycar"><a href="javascript:;"></a></router-link>
      <router-link tag="li" class="my" to="/user"><a href="javascript:;"></a></router-link>

      <!-- <li tag="li" class="home"><a href="index_m.html"></a></li>
      <li tag="li" class="write"><a href="javascript:;"></a></li>
      <li tag="li" class="my"><a href="mydoc_m.html"></a></li> -->
    </ul>
  </div> 
</template>

<style scoped>
.foot-btn{width:100%;height:0.8rem; background:wheat; position:fixed; left:0; bottom:0; border-top:1px solid #9e9a95;}
